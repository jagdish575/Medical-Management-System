...
from .models import Dealer, Medicine, Employee, Customer, Purchase, Profile
...
class AddMedicineForm(forms.ModelForm):
    med_code = forms.CharField(
        max_length=20,
        validators=[
            RegexValidator(r"^\d+$", message="Only whole numbers are allowed.")
        ],
    )
...
class AddEmployeeForm(forms.ModelForm):
    class Meta:
        model = Employee
        fields = ["fname", "lname", "address", "salary", "phone_number", "email"]
        widgets = {
            "fname": forms.TextInput(
                attrs={
                    "class": "form-control",
...
class AddPurchaseForm(forms.ModelForm):
    class Meta:
        model = Purchase
        fields = ["customer", "med_name", "price_number", "quantity"]
        widgets = {
...
class UpdatePurchaseForm(forms.ModelForm):
    class Meta:
        model = Purchase
        fields = ["med_name", "customer", "price_number", "quantity"]
        widgets = {
            "med_name": forms.Select(
                attrs={
                    "class": "form-control",
...
class AddOrderForm(forms.ModelForm):
    class Meta:
        model = Order
        fields = ["customer", "med_name", "price", "quantity"]
        widgets = {
            "med_name": forms.Select(
                attrs={
                    "class": "form-control",
