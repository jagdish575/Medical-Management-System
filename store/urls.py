...
urlpatterns = [
    ...
    path(
        "medicines/update-medicine/<int:pk>/", update_medicine, name="update-medicine"
    ),
    path(
        "medicines/delete-medicine/<int:pk>/", delete_medicine, name="delete-medicine"
    ),
    # Employee CRUD
    path("employees/", employees_page, name="view-employees"),
    path("employees/add-employee/", add_employee_page, name="add-employee"),
    path(
        "employees/update-employee/<int:pk>/", update_employee, name="update-employee"
    ),
    path(
        "employees/delete-employee/<int:pk>/", delete_employee, name="delete-employee"
    ),
    # Customer CRUD
    path("customers/", customers_page, name="view-customers"),
    path("customers/add-customer/", add_customer_page, name="add-customer"),
    path(
        "customers/update-customer/<int:pk>/", update_customer, name="update-customer"
    ),
    path(
        "customers/delete-customer/<int:pk>/", delete_customer, name="delete-customer"
    ),
    # Purchase CRUD
    path("purchases/", purchases_page, name="view-purchases"),
    path("purchases/add-purchase/", add_purchase_page, name="add-purchase"),
    path(
        "purchases/update-purchase/<int:pk>/", update_purchase, name="update-purchase"
    ),
    path(
        "purchases/delete-purchase/<int:pk>/", delete_purchase, name="delete-purchase"
    ),
